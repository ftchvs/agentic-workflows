...
Read [references/example-packages.md](https://github.com/MengTo/Skills/blob/321c769739b823de5eb94eb3a52aa1974fe783a2/agent-skills/codex/article-prompts-to-skills/references/example-packages.md) for visual, mixed-source, and workflow examples.
