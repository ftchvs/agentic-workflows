...
Read [references/example-prompts.md](https://github.com/MengTo/Skills/blob/321c769739b823de5eb94eb3a52aa1974fe783a2/agent-skills/codex/generate-reference-inspired-brand-worlds/references/example-prompts.md) when generating a multi-brand set or a closer-to-reference V2. It contains the MOSSWEFT, KINTRA, NIGHTJAR, TIDETURN, and EMBERHOUSE prompt patterns.
